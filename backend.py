...
def backtest(df,custom_column='trac',plot_capital=False,return_df=False,strat_name='PUT STRATEGY HERE'):
    '''
...
def sma_up_validation(df,sma_variable,long_sma,strat_name,look_back,rdf,plot_capital=False):
    ...
    result = backtest(df,strat_name='SMA-Price-CROSS',plot_capital=plot_capital) 
    #print(result)
